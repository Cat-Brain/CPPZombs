...
"void main()"
"{\n"
"	vec3 totalLight = color\n"
"	ivec2 disp = center - pos;\n"
"	int largestDist = max(abs(disp.x), abs(disp.y));\n"
"	vec2 dir = vec2(disp) / largestDist;\n"
"	for (int i = 1; i < largestDist; i++)\n"
"	{\n"
"		\n"
"	}\n"
"	FragColor = color;\n"
