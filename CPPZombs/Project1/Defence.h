...
public:
	...
	Vine(Collectible* collectible, int cyclesToGrow, int deadStage, int maxGenerations, int chanceForSeed,
		...
		RGBA deadColor = RGBA(), RGBA subsurfaceResistance = RGBA(),
		float mass = 1, int maxHealth = 1, int health = 1, string name = "NULL NAME") :
		Tree(collectible, cyclesToGrow, deadStage, chanceForSeed, timePer, pos, radius, color, adultColor, deadColor, subsurfaceResistance, mass, maxHealth, health, name),
...
namespace Plants
{
	namespace Trees
	{
		...
		Tree* copperTree = new Tree(Collectibles::copper, 5, 25, 25, 4.0f, vZero, 0.5f, babyCopperTreeColor, copperTreeColor, deadCopperTreeColor, copperResistence, 1, 1, 1, "Copper tree");
		...
		Tree* ironTree = new Tree(Collectibles::iron, 120, 180, 10, 0.5f, vZero, 0.5f, babyIronTreeColor, ironTreeColor, deadIronTreeColor, ironResistence, 1, 1, 1, "Iron tree");
		...
		Tree* rubyTree = new Tree(Collectibles::ruby, 5, 15, 50, 4.0f, vZero, 0.5f, babyRubyTreeColor, rubyTreeColor, deadRubyTreeColor, rubyResistence, 1, 1, 1, "Ruby tree");
		...
		Tree* emeraldTree = new Tree(Collectibles::emerald, 5, 15, 50, 4.0f, vZero, 0.5f, babyEmeraldTreeColor, emeraldTreeColor, deadEmeraldTreeColor, emeraldResistence, 1, 1, 1, "Emerald tree");
		...
		Tree* rockTree = new Tree(Collectibles::rock, 5, 8, 75, 4.0f, vZero, 0.5f, babyRockTreeColor, rockTreeColor, deadRockTreeColor, rockResistence, 1, 1, 1, "Rock tree");
		
		RGBA babyShadeTreeColor = RGBA(50, 50), shadeTreeColor = RGBA(25, 25), deadShadeTreeColor = RGBA(), shadeResistence = RGBA();
		Tree* shadeTree = new Tree(Collectibles::shades, 10, 30, 25, 1.0f, vZero, 0.5f, babyShadeTreeColor, shadeTreeColor, deadShadeTreeColor, shadeResistence, 1, 1, 1, "Shade tree");
		...
		Tree* bowlerTree = new Tree(Collectibles::bowler, 1, 50, 50, 16.0f, vZero, 1.5f, babyBowlerTreeColor, bowlerTreeColor, deadBowlerTree, bowlerResistence, 5, 50, 50, "Bowler tree");
	}
...
namespace Resources::Seeds
{
	...
	PlacedOnLanding* bowlerTreeSeed = new PlacedOnLanding(Plants::Trees::bowlerTree, "Bowler tree seed", "Seed", 4, Plants::Trees::bowlerTreeColor, Resources::bowler->subScat, 0, 1, 15, false, 0.25f, 1.5f);
	// Vines
